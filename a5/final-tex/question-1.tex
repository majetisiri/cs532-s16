...
\end{figure}
\newpage
\item Comparison between the `Faction graph' and the resultant Karate Club split graph generated from `Girvan Newman' algorithm is illustrated below in Table \ref{Table:q1table1}
\begin{table}
